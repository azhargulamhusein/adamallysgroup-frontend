...
const IndustrialEnergy = ({ image, video, caption, isIndustrial }) => {
  return (
    <div style={{ height: "100%" }}>
        ...
        {video ? (
          ...
          <Image
            ...
            src={
              ...
              "/images/products-&-services/industrial-energy-image.png"
            }
            alt="industrial-energy-image"
            width={1646}
            height={529}
          />
        )}
      ...
      <div
        className={`sticky ${
          isIndustrial ? "top-[170px]" : /* "top-20" */ "top-[15rem]"
        } blue_gradient2 px-[18px] md:px-[47px] py-[58px] relative z-[9]`}
      >
