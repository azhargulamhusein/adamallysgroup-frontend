...
const DistributorsAndStockistsTemplate = ({ Cards, Banner }) => {
  ...
  return (
    <main className="mt-[5rem] lg:mt-[8rem] container mx-auto px-3 xl:px-0">
      <section>
        <div
          className={`relative min-h-[418px] flex flex-col text-white justify-center items-center`}
          style={{
        ...
        >
          ...
          <div className={`absolute black_gradient inset-0`}></div>
        </div>
      </section>
      ...
      <div className="my-10 md:my-[68px] px-2 flex webkit-flex webkit-wrap flex-wrap gap-[24px]">
        {data?.map((distributor, index) => (
          <div
            ...
            className="basis-full flex-1 lg:basis-[40%] relative border border-[#B2B6E0] flex flex-col min-h-[360px]"
          >
            <div className="flex webkit-flex flex-row flex-dir-row flex-grow">
              ...
              <div className="flex-1 pt-[42px] px-4 lg:pl-[64px] lg:pr-[57px] flex flex-col justify-center">
                <p className="text-theme-main font-bold text-lg text-center md:text-left md:text-[30px] leading-[44px] md:mb-3">
                  {distributor?.title}
                </p>
                <div className="lg:flex-grow mb-10 flex webkit-flex flex-col flex-dir-col justify-center md:justify-start md:items-start">
                  <p
                    ...
                    className={`text-[#3E3E3E] font_calibri text-center md:text-left text-xs inline-block font-light md:text-lg leading-[15px] md:leading-[26px] ${
                      expanded[distributor.title] ? "" : "truncate"
                    }`}
                    style={{
                      whiteSpace: "wrap",
            ...
            <div className="flex webkit-flex justify-center gap-4 lg:gap-8 py-2 lg:py-4  items-center mt-1 mb-1 px-2">
              {distributor?.link && (
                <a
                  className="whitespace-nowrap font_calibri text-xs bg-white  md:text-lg font-bold leading-[26px] text-theme-main py-2 lg:py-4 px-[30px] md:px-[50px] xl:px-[65px] border border-[#B2B6E0] rounded-[30px]"
              ...
              <a
                className="whitespace-nowrap font_calibri bg-white text-xs md:text-lg font-bold leading-[26px] text-theme-main py-2 lg:py-4 px-[30px] md:px-[50px] xl:px-[65px] border border-[#B2B6E0] rounded-[30px]"
        ...
        {data.length % 2 !== 0 && (
          <div className="basis-full flex-1 hidden md:flex md:webkit-flex justify-center flex-col items-center bg-gradient-to-r from-[#2E368F] to-[#B2B6E0] opacity-75 lg:basis-[40%] relative border min-h-[360px]">
            <Image
              priority
              src="/svg/site-fav.svg"
              alt=""
              width={174}
              height={84}
            />
