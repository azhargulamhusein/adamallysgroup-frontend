...
const Warehousing = (props) => {
  ...
  return (
    <div>
      ...
      <h2 className="text-[25px] text-center md:hidden mt-4 lg:leading-[67px] font-bold text-theme-main !mb-0">
      ...
      <p className="text-[12px] font-light text-center leading-[26px] py-3 md:hidden px-[18px] md:px-0">
        At Adamallys, we offer a comprehensive range of high-quality products
        essential for the industrial, oil, and gas sectors. Our extensive
        inventory supports efficient and safe operations across offshore and
        onshore projects, addressing the specific needs of these demanding
        industries.
      </p>
      <div
        style={{
      ...
      >
        <section className="mt-6 md:mt-[71px] relative container mx-auto flex flex-col lg:flex-row gap-5 lg:gap-10 mb-6 lg:mb-20">
          ...
          <div className="lg:w-[70%] mt-[-14px]">
            <h2 className="text-[25px] text-center md:text-left md:text-[60px] leading-[67px] font-bold text-theme-main !mb-0">
              {title}
            </h2>
        ...
        <section className="mt-6 md:mt-[71px] container mx-auto flex flex-col lg:flex-row gap-5 lg:gap-10 ">
          ...
          <div className="lg:w-[70%] mt-[-14px]">
            <h2 className="text-[25px] text-center md:text-[60px] md:text-left leading-[67px] font-bold text-theme-main !mb-0">
              Warehousing
            </h2>
            ...
            <div className="flex flex-col sm:flex-row space-y-[17px] sm:space-y-[0] sm:space-x-[17px] mt-[42px]">
              {Cards?.map((card) => (
                <div
                  key={card?.id}
                  className="blue_gradient2 px-[30px] py-[58px] flex-1"
                >
