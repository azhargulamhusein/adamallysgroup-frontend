    ...
    <>
      ...
      >
        <div
          style={{
            background:
              "linear-gradient(to bottom, rgba(23, 31, 124, 0), rgba(23, 31, 124, 1))",
          }}
      ...
      <div className="lg:sticky top-20 mt-[40px]-- z-[-1]">
        <TwoColumnContent
          invert
          bgGray
          zeroGap
      ...
      <section
        className={`px-[18px] md:px-0 lg:sticky container mx-auto grid pb-4 z-9 bg-white`}
      >
        <div>
          <figure>
            <Image
        ...
        <div
          className={`p-8 xl:p-14 leading-10  text-white bg-theme-main flex-col gap-2`}
        >
          <h2
            className={`font_franklin text-center text-[25px] leading-[30px] lg:text-[40px] lg:leading-[49px]`}
          >
